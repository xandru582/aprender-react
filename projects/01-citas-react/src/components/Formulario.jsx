  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
        ...
        <form onSubmit={handleSubmit} action="" className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
            {error && <Error ><p>Todos los campos son obligaroios</p></Error> }
            <div className="mb-5">
            ...
            <input type="submit" className="bg-indigo-600 w-full p-3 text-white uppercase font-bold cursor-pointer transition-all
             hover:bg-indigo-700" value={ paciente.id ? 'Editar paciente' : 'Agregar paciente'}/>
        </form>
    </div>
  )
}
